...
### In this step we use the function findFreqTerms() to eliminate any word that appear less than about 0.1 percent in this case in both in frequ train and test datasets.
...
## Step 16. Naibe Bayes classification outputs.
